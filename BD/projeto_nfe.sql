...
--
-- Host: 127.0.0.1
-- Generation Time: 09-Jun-2019 às 12:01
...
INSERT INTO `configuracao` (`id_config`, `ambiente`, `serie`, `certificado`, `senha`, `versao`, `empresa_padrao`, `ultimanfe`) VALUES
(1, 2, '1', '1000282109.pfx', '120000', '4.00', 1, 200);
...
INSERT INTO `contato` (`id_contato`, `eh_cliente`, `eh_fornecedor`, `eh_transportador`, `nome`, `nome_fantasia`, `cpf`, `cnpj`, `data_cadastro`, `ativo`, `ddd`, `fone`, `celular`, `email`, `senha`, `cep`, `logradouro`, `numero`, `id_estado`, `id_cidade`, `complemento`, `bairro`, `ie`, `im`, `rg`, `suframa`, `cod_estrangeiro`, `ie_subt_trib`, `indIEDest`) VALUES
(1, 'S', 'S', 'S', 'Manoel Jailton ', '', '78589452387', '', '0000-00-00', 'S', '98', '999924667', '999924667', 'mjailton@gmail.com', '123', '65030700', 'Rua Hugo da Cunha Machado', '103', 10, 636, '', 'Fátima', '', '', NULL, '', '', NULL, 9),
(2, 'N', 'N', 'S', 'Empresa brasileira de Correios e Telégraros', 'Correios', '', '', '0000-00-00', 'S', '98', '32367293', '', 'correios@correios.com.br', '123', '65071140', 'Av. Jerônimo de Albuquerque', '12', 10, 636, '', 'Vinhais', '1123888533119', '', NULL, '', '', '', NULL),
(3, 'S', 'S', 'N', 'Fornecedor Teste', '', '', '', '0000-00-00', 'S', '', '', '', 'atendimentomjailton@gmail.com', '123', '', '', '', 10, 636, '', '', '', '', NULL, '', '', '', NULL),
(4, 'N', 'S', 'N', 'Terceiro fornecedor', '', '', '', '0000-00-00', 'S', '', '', '', 'cursosdetreinamento@gmail.com', '123', '', '', '', 10, 636, '', '', '', '', NULL, '', '', '', NULL);
...
CREATE TABLE `tributacao_cofins` (
  ...
  `codigo_cofins` varchar(25) NOT NULL,
  `pCofins` double(15,2) DEFAULT NULL,
  `cofins_TipoCalc` int(11) DEFAULT NULL,
  `cofins_vAliqProd` double(15,2) DEFAULT NULL,
  `cofins_vAliqProdST` double(15,2) DEFAULT NULL,
  `cofins_TipoCalcST` int(11) DEFAULT NULL,
  `cofins_STpCofins` decimal(10,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tributacao_cofins` (`id_tributacao_cofins`, `id_tributacao`, `codigo_cofins`, `pCofins`, `cofins_TipoCalc`, `cofins_vAliqProd`, `cofins_vAliqProdST`, `cofins_TipoCalcST`, `cofins_STpCofins`) VALUES
(1, 1, '07', NULL, 0, NULL, NULL, NULL, '0.00');
...
CREATE TABLE `tributacao_ipi` (
  ...
  `codigo_ipi` varchar(20) NOT NULL,
  `id_tributacao` int(11) DEFAULT NULL,
  ...
  `TipoCalc` int(11) DEFAULT NULL,
  `pIPI` double(15,2) DEFAULT NULL,
  `vUnid` double(15,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tributacao_pis` (
  ...
  `id_tributacao` int(11) DEFAULT NULL,
  `codigo_pis` varchar(25) NOT NULL,
  `pPIS` double(15,2) DEFAULT NULL,
  `pis_TipoCalc` int(11) DEFAULT NULL,
  `pPIS_St` double(15,2) DEFAULT NULL,
  `pis_vAliqProdSt` double(15,2) DEFAULT NULL,
  `pis_vAliqProd` double(15,2) DEFAULT NULL,
  `pis_TipoCalcSt` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tributacao_pis` (`id_tributacao_pis`, `id_tributacao`, `codigo_pis`, `pPIS`, `pis_TipoCalc`, `pPIS_St`, `pis_vAliqProdSt`, `pis_vAliqProd`, `pis_TipoCalcSt`) VALUES
(4, 1, '07', NULL, 0, NULL, NULL, NULL, NULL);
...
--
-- AUTO_INCREMENT for table `tributacao`
--
ALTER TABLE `tributacao`
  MODIFY `id_tributacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tributacao_cofins`
--
ALTER TABLE `tributacao_cofins`
  MODIFY `id_tributacao_cofins` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tributacao_icms`
--
ALTER TABLE `tributacao_icms`
  MODIFY `id_tributacao_icms` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tributacao_ipi`
--
ALTER TABLE `tributacao_ipi`
  MODIFY `id_tributacao_ipi` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tributacao_pis`
--
ALTER TABLE `tributacao_pis`
  MODIFY `id_tributacao_pis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
