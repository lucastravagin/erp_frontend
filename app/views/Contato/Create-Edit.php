			...
			<div class="col-12">
				<div class="caixa">
					<div class="caixa-titulo py-1 d-inline-block width-100">
							...
							<a href="<?php echo URL_BASE?>contato/index" class="btn btn-amarelo float-right"><i class="fas fa-arrow-left mb-0"></i> Voltar</a>
					</div>
					<form action="" method="">
						<div class="p-5 pb-0 pt-4 width-100 float-left">
							<ul class="tabs">
								<li class="current" data-tab="tab-1">Dados Gerais</li>
								<li data-tab="tab-2" class="">Endereço</li>
								<li data-tab="tab-3" class="">Informações Adicionais</li>
							</ul>
						...
						<div id="tab-2" class="tab-content">									
							...
							<div class="rows pb-4">																					
								...
								<div class="col-6 mb-3">
										...
										<input type="text" name="logradouro" id="logradouto" value="<?php echo (isset($contato)) ?  $contato->logradouto : NULL ?>" placeholder="Digite aqui..." class="form-campo">
								</div>
